...
\section{Título}
\textbf{Denominación del Entregable:} Modelo Conceptual ER, Esquema Lógico Relacional y Diccionario de Datos PostgreSQL 16 (EDT 2.4)
...
\section{Índices de Rendimiento y Control de Integridad DDL}
...
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}m{2.9cm}|>{\raggedright\arraybackslash}X|>{\centering\arraybackslash}m{4.6cm}|>{\centering\arraybackslash}m{2.3cm}|}
    ...
    \hline
    \textbf{Elaborado por:} & Nixon Hurtado\newline \textit{Desarrollador Backend / Ingeniero DBA} & \parbox[c]{4.4cm}{\centering\vspace{4pt}\includegraphics[height=1.5cm,width=4.0cm,keepaspectratio]{images/firma_heidi.png}\vspace{4pt}} & 02/09/2026 \\
    \hline
...
\begin{tabularx}{\textwidth}{|>{\hsize=0.45\hsize\centering\arraybackslash}X|>{\hsize=1.55\hsize\raggedright\arraybackslash}X|>{\hsize=1.2\hsize\raggedright\arraybackslash}X|>{\hsize=0.8\hsize\centering\arraybackslash}X|}
    ...
    \hline
    1.0 & Diseño de base de datos relacional ERD, diccionario de datos y DDL PostgreSQL 16 / Pendiente de revisión & Nixon Hurtado & \textbf{\textcolor{gray!90}{Pendiente de Revisión}} \\
    \hline
\end{tabularx}
...
\section{Anexos}
\subsection*{Anexo 1: Script DDL de Migraciones Iniciales de Entity Framework Core}
Definición de clases de mapeo \texttt{EntityTypeConfiguration} para llaves compuestas, índices y cascadas controladas.
