...
\section{Introducción y Estrategia de Contenedores}
Para garantizar reproducibilidad en los entornos de desarrollo, pruebas y producción sin incurrir en costos de licencias comerciales ni saturar los recursos de hardware, el sistema \textbf{SIGE} implementa una arquitectura eficiente y desacoplada mediante \textbf{Docker Compose}:
...
\section{Especificación del Archivo \texttt{docker-compose.yml}}
...
\section{Comandos de Despliegue y Verificación Local}
