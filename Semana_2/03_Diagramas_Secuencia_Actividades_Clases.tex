...
Modela las interacciones entre los actores del SGC (Docente Responsable, Coordinador de Área, Coordinador de Carrera, Administrador), el cliente frontend (React + Vite), el backend REST en Node.js + Express (v5), el validador determinista, la base de datos PostgreSQL 18, el almacenamiento de objetos MinIO S3 y el motor criptográfico FirmaEC.
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt, topsep=2pt]
    \item \textbf{Steeven Toala (Líder / Arquitecto):} Modelado de diagramas de secuencia, protocolo de firmas y arquitectura modular.
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
    ...
    \item Implementar las precondiciones de cascada mediante middlewares modulares de validación en Express (v5) y constraints en PostgreSQL 18.
\end{itemize}
...
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}m{2.9cm}|>{\raggedright\arraybackslash}X|>{\centering\arraybackslash}m{4.6cm}|>{\centering\arraybackslash}m{2.3cm}|}
    ...
    \hline
    \textbf{Elaborado por:} & Steeven Toala\newline \textit{Líder de Proyecto / Arquitecto Software} & \parbox[c]{4.4cm}{\centering\vspace{4pt}\includegraphics[height=1.5cm,width=4.0cm,keepaspectratio]{images/firma_steveen.png}\vspace{4pt}} & 02/09/2026 \\
    \hline
    \textbf{Revisado por:} & Heidy Villavicencio\newline \textit{Analista de Requerimientos / UI-UX} & \parbox[c]{4.4cm}{\centering\vspace{4pt}\includegraphics[height=1.5cm,width=4.0cm,keepaspectratio]{images/firma_heidi.png}\vspace{4pt}} & 02/09/2026 \\
    \hline
...
\begin{tabularx}{\textwidth}{|>{\hsize=0.45\hsize\centering\arraybackslash}X|>{\hsize=1.55\hsize\raggedright\arraybackslash}X|>{\hsize=1.2\hsize\raggedright\arraybackslash}X|>{\hsize=0.8\hsize\centering\arraybackslash}X|}
    ...
    \hline
    1.0 & Modelado formal de diagramas de secuencia con FirmaEC, actividades y clases UML para Séptimo Semestre "A" & Steeven Toala & 02/09/2026 \\
    \hline
\end{tabularx}
...
\subsection*{Anexo 1: Especificación de Algoritmos Criptográficos para FirmaEC}
Parámetros de conexión local al agente FirmaEC vía WebSocket/Loopback y validación de listas de revocación CRL / OCSP.

\subsection*{Anexo 2: Referencias Bibliográficas}
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
