...
Durante la \textbf{Semana 2: Diseño Rápido y Arquitectura}, el equipo de desarrollo completó con éxito el 100\% de los modelos de diseño técnico, estructural y visual del sistema \textbf{SIGE}. Se definieron los diagramas UML de Casos de Uso, la Arquitectura Modular en capas sobre Node.js + Express (v5) y PostgreSQL 18, los diagramas de interacción de secuencia/actividades/clases con el modelado formal de FirmaEC, el modelo relacional en 3FN, el sistema de diseño visual en Figma y Tailwind CSS con la paleta institucional \texttt{\#00345E}, y la orquestación completa de servicios en Docker Compose.
...
\begin{itemize}[leftmargin=1.5em, itemsep=1.5pt]
    ...
    \item Establecer la trazabilidad entre los casos de uso, la Arquitectura Modular en Node.js + Express (v5) y el esquema de persistencia en PostgreSQL 18.
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
    \item \textbf{Arquitectura Modular:} Patrón arquitectónico que divide la aplicación en módulos autocontenidos por dominio con bajo acoplamiento y alta cohesión.
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
    \item \textbf{Steeven Toala (Líder / Arquitecto):} Consolidación del informe general, revisión de Arquitectura Modular y cierre de fase.
...
\begin{enumerate}[leftmargin=1.5em, itemsep=2.5pt]
    ...
    \item \textbf{EDT 2.2 -- Diseño de Arquitectura de la Solución (Arquitectura Modular Node.js Express v5):} Especificación de la Arquitectura Modular en capas sobre Node.js + Express (v5), estructura monorepo \texttt{SIGE/}, diagramas C4 y seguridad con JWT/Helmet.
    ...
    \item \textbf{EDT 2.4 -- Diseño de Base de Datos (Modelo ER y DDL PostgreSQL 18):} Diagrama Entidad-Relación (ERD) en 3FN para PostgreSQL 18, diccionario de datos de 9 entidades e índices DDL de rendimiento.
    \item \textbf{EDT 2.5 -- Diseño de Interfaces, Wireframes y UX (Paleta \#00345E / Tailwind CSS):} Sistema de diseño con la paleta institucional \texttt{\#00345E} (Azul UTA/FISEI), componentes Tailwind CSS, wireframes y accesibilidad WCAG 2.1 AA.
    \item \textbf{EDT 2.6 -- Arquitectura de Contenedores Docker (docker-compose.yml):} Archivo \texttt{docker-compose.yml} completo con PostgreSQL 18, MinIO S3, LanguageTool, backend Express v5 y frontend React + Vite.
\end{enumerate}
...
\begin{tabularx}{\textwidth}{|>{\hsize=0.7\hsize\bfseries}X|>{\hsize=1.0\hsize}X|>{\hsize=0.45\hsize\centering\arraybackslash}X|>{\hsize=1.2\hsize}X|>{\hsize=0.65\hsize\centering\arraybackslash}X|}
    ...
    \hline
    Steeven Toala & Líder de Proyecto / Arquitecto & 20 h & Arquitectura Modular, C4, Docker Compose, Clases UML & \textbf{100\% Completo} \\
    \hline
    Heidy Villavicencio & Analista de Requerimientos / UI-UX & 18 h & Casos de Uso, Wireframes Figma, Secuencias & \textbf{100\% Completo} \\
    \hline
    Nixon Hurtado & Desarrollador Backend / DBA & 18 h & Modelo ER PostgreSQL 18, Diccionario Datos, MinIO Init & \textbf{100\% Completo} \\
    \hline
    Andrea Vasquez & Desarrolladora Frontend / QA Tester & 16 h & Diseño de Componentes React + Vite, Accesibilidad UX & \textbf{100\% Completo} \\
    \hline
    \rowcolor{gray!15}
...
Con la culminación de la Semana 2, el proyecto \textbf{SIGE} queda formalmente preparado para el inicio del desarrollo e implementación transaccional, arrancando en la \textbf{Semana 3} con los scripts DDL de inicialización de PostgreSQL 18 (\texttt{schema.sql}, \texttt{init.js}), los seeders del catálogo institucional SGC (\texttt{seed.sql}), los servicios de autenticación y seguridad con Bcrypt.js, JWT y Helmet en Express v5, y el cliente base SPA React + Vite con Tailwind CSS y CSS Keyframes (\texttt{\#00345E}).
...
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}m{2.9cm}|>{\raggedright\arraybackslash}X|>{\centering\arraybackslash}m{4.6cm}|>{\centering\arraybackslash}m{2.3cm}|}
    ...
    \hline
    \textbf{Elaborado por:} & Steeven Toala\newline \textit{Líder de Proyecto / Arquitecto Software} & \parbox[c]{4.4cm}{\centering\vspace{4pt}\includegraphics[height=1.5cm,width=4.0cm,keepaspectratio]{images/firma_steveen.png}\vspace{4pt}} & 04/09/2026 \\
    \hline
