...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
    \item \textbf{W3C Web Content Accessibility Guidelines (WCAG 2.1 - Nivel AA):} Contraste tipográfico y navegación accesible.
    \item \textbf{Estándar IEEE 1471:} Buenas prácticas en arquitectura de software cliente.
\end{itemize}
