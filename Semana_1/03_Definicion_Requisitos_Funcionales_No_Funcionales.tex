...
\begin{itemize}[leftmargin=1.5em, itemsep=1.5pt, topsep=1.5pt]
    ...
    \item \textbf{Período de Ejecución:} Semana 1 (17/08/2026 al 19/08/2026)
\end{itemize}
...
Define los requisitos de la aplicación web responsive (React/TypeScript) y de los microservicios backend (.NET 8/PostgreSQL/MinIO/LanguageTool y Google Gemini API).
...
\begin{tabularx}{\textwidth}{|>{\hsize=0.35\hsize\bfseries\centering\arraybackslash}X|>{\hsize=0.65\hsize\bfseries}X|>{\hsize=1.0\hsize}X|>{\hsize=1.0\hsize}X|}
    ...
    \hline
    RNF-01 & Seguridad & Cifrado de contraseñas con BCrypt, protección contra inyecciones SQL y sanitización XSS. & Cumplimiento de estándares OWASP Top 10. \\
    \hline
    RNF-02 & Rendimiento & Tiempo de respuesta de endpoints de consulta y guardado. & Menor a 500 ms bajo carga normal (50 usuarios concurrentes). \\
    \hline
    ...
    \hline
    RNF-04 & Usabilidad & Diseño sobrio en paleta Azul y Blanco institucional con navegación guiada por pestañas. & Cero saturación visual; reducción de errores de digitación en un $80\%$. \\
    \hline
    ...
    \hline
    RNF-07 & Mantenibilidad & Arquitectura limpia (Clean Architecture) con separación estricta en capas y pruebas unitarias. & Cobertura de pruebas unitarias $> 80\%$ en lógica de dominio. \\
    \hline
    RNF-08 & Integridad de Datos & Persistencia relacional ACID y respaldo periódico de la base de datos PostgreSQL y MinIO. & RPO $< 24$ horas, RTO $< 2$ horas ante fallos catastróficos. \\
    \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}m{2.9cm}|>{\raggedright\arraybackslash}X|>{\centering\arraybackslash}m{4.6cm}|>{\centering\arraybackslash}m{2.3cm}|}
    ...
    \hline
    \textbf{Elaborado por:} & Heidi Villavicencio\newline \textit{Analista de Requerimientos / UI-UX} & \parbox[c]{4.4cm}{\centering\vspace{4pt}\includegraphics[height=1.5cm,width=4.0cm,keepaspectratio]{images/firma_heidi.png}\vspace{4pt}} & 18/08/2026 \\
    \hline
