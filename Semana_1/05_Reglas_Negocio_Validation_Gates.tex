...
\begin{enumerate}[leftmargin=1.5em, itemsep=2pt, topsep=2pt]
    \item Especificar las 9 reglas de negocio deterministas del SGC con sus formulaciones matemáticas y validaciones en C\# FluentValidation.
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
    ...
    \item Validación reactiva en frontend (React + Zod) y validación estricta transaccional en backend (.NET 9 + FluentValidation).
\end{itemize}
...
\begin{tabularx}{\textwidth}{|>{\hsize=0.6\hsize\bfseries}X|>{\hsize=0.9\hsize}X|>{\hsize=1.5\hsize}X|}
    ...
    \hline
    Nixon Hurtado & Backend / DBA & Implementación de las reglas en FluentValidation (.NET 9) y triggers de base de datos. \\
    \hline
...
RuleFor(a => a.Observaciones)
    ...
    .WithMessage("Las actividades con avance menor al 100% deben incluir una justificacion de desvio de al menos 10 caracteres.");
\end{lstlisting}
