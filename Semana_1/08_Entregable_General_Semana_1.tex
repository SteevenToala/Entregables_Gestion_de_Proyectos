...
\newcommand{\docCodigo}{TI-SIGE-ENT-S1-008}
...
\section{Título}
\textbf{Denominación del Entregable:} Informe Consolidado de Cierre de Fase de Análisis, Planificación y Fundamentación de Negocio (EDT 1.8)



\section{Introducción}
Durante la \textbf{Semana 1: Análisis y Planificación}, el equipo de desarrollo cumplió satisfactoriamente con el 100\% de los objetivos fijados en el cronograma maestro del proyecto \textbf{SIGE}. Se formalizó el levantamiento del flujo documental del Sistema de Gestión de Calidad (SGC), se especificaron los requerimientos bajo estándar IEEE 830, se delimitaron las reglas de negocio deterministas (\textit{Validation Gates}), se consolidó el Caso de Negocio con un Retorno de Inversión (ROI) superior al \textbf{+3,660\%} y se estableció formalmente el Plan de Gestión del Proyecto con la Estructura de Desglose del Trabajo (EDT) de 49 tareas y el cronograma en Microsoft Project (57 días laborables / 456 horas netas).

\section{Objetivo}

\subsection{Objetivo General}
Consolidar formalmente la línea base de requerimientos, alcance, planificación y factibilidad de la Semana 1, certificando el cumplimiento del 100\% de los 7 entregables técnicos requeridos para habilitar el paso a la Fase 2 de Diseño de Arquitectura y Modelado UML.

\subsection{Objetivos Específicos}
\begin{enumerate}[leftmargin=1.5em, itemsep=2pt, topsep=2pt]
    \item Verificar la finalización y aprobación técnica de los 7 paquetes de trabajo EDT de la Semana 1 (EDT 1.1 al EDT 1.7).
    \item Establecer la trazabilidad integral entre el diagnóstico As-Is, actores, requerimientos, reglas de negocio, caso de negocio y cronograma maestro.
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
    \item Abarca la totalidad de artefactos de análisis y planificación producidos entre el 12 y el 24 de agosto de 2026 (EDT 1.1 al EDT 1.7).
\end{itemize}
...
\begin{tabularx}{\textwidth}{|>{\hsize=0.65\hsize\bfseries}X|>{\hsize=0.85\hsize}X|>{\hsize=1.5\hsize}X|}
    ...
    \hline
    Steeven Toala & Líder / Arquitecto & Revisión de coherencia global de arquitectura, planificación y cierre de fase. \\
    \hline
    ...
    \hline
\end{tabularx}
\caption{Matriz de Responsabilidades del Entregable EDT 1.8.}
\end{table}
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
    ...
    \item \textbf{Guía del PMBOK (7ma Edición):} Gestión del Alcance, Integración y Cronograma de Proyectos.
\end{itemize}

\section{Método, Políticas y Contenidos}
El flujo de dependencia de los 7 artefactos producidos durante la Semana 1 se representa en el siguiente mapa consolidado:
...
\begin{enumerate}[leftmargin=1.5em, itemsep=2.5pt]
    ...
    \item \textbf{EDT 1.7 -- Planificación del Proyecto y Cronograma EDT:} Plan de Gestión del Proyecto, EDT de 49 tareas, cronograma MS Project (57 días laborables / 456 horas), dependencias y asignación de recursos.
\end{enumerate}
...
\begin{tabularx}{\textwidth}{|>{\hsize=0.7\hsize\bfseries}X|>{\hsize=1.0\hsize}X|>{\hsize=0.45\hsize\centering\arraybackslash}X|>{\hsize=1.2\hsize}X|>{\hsize=0.65\hsize\centering\arraybackslash}X|}
    ...
    \hline
    Steeven Toala & Líder de Proyecto / Arquitecto & 20 h & Scope, Validation Gates, EDT y Cronograma MS Project & \textbf{100\% Completo} \\
    \hline
    Heidy Villavicencio & Analista de Requerimientos / UI-UX & 18 h & Relevamiento As-Is, SRS IEEE 830, RACI & \textbf{100\% Completo} \\
    \hline
    Nixon Hurtado & Desarrollador Backend / DBA & 17 h & Reglas de datos, Caso de Negocio, MinIO & \textbf{100\% Completo} \\
    \hline
    Andrea Vasquez & Desarrolladora Frontend / QA Tester & 17 h & Pruebas de requerimientos, RTM, RNF, verificación EDT & \textbf{100\% Completo} \\
    \hline
    \rowcolor{gray!15}
    \textbf{TOTAL SEMANA 1} & \textbf{Equipo de Desarrollo SIGE} & \textbf{72 h} & \textbf{7 Paquetes de Trabajo EDT} & \textbf{Aprobado} \\
    \hline
\end{tabularx}
\caption{Matriz de Control de Esfuerzo y Desempeño - Semana 1.}
\label{tab:s1_08_esfuerzo}
\end{table}

\subsection{Conclusión y Transición a la Semana 2}
Con la culminación de la Semana 1, el proyecto \textbf{SIGE} cuenta con una base sólida de ingeniería de requerimientos y planificación temporal para ingresar a la \textbf{Semana 2: Diseño Rápido y Arquitectura}, donde se generarán los diagramas UML de Casos de Uso, la arquitectura modular en Node.js + Express (v5), los diagramas de secuencia/clases, el modelo relacional en PostgreSQL 18, los prototipos UI/UX en Figma con la paleta \#00345E y la orquestación en Docker Compose.
...
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}m{2.9cm}|>{\raggedright\arraybackslash}X|>{\centering\arraybackslash}m{4.6cm}|>{\centering\arraybackslash}m{2.3cm}|}
    ...
    \hline
    \textbf{Elaborado por:} & Heidy Villavicencio\newline \textit{Analista de Requerimientos / UI-UX} & \parbox[c]{4.4cm}{\centering\vspace{4pt}\includegraphics[height=1.5cm,width=4.0cm,keepaspectratio]{images/firma_heidi.png}\vspace{4pt}} & 24/08/2026 \\
    \hline
...
\begin{tabularx}{\textwidth}{|>{\hsize=0.45\hsize\centering\arraybackslash}X|>{\hsize=1.55\hsize\raggedright\arraybackslash}X|>{\hsize=1.2\hsize\raggedright\arraybackslash}X|>{\hsize=0.8\hsize\centering\arraybackslash}X|}
    ...
    \hline
    1.0 & Consolidación final de los 7 entregables de la Semana 1, inclusión del Plan de Gestión del Proyecto y Cronograma EDT, y cierre formal de Fase 1. & Heidy Villavicencio / Steeven Toala & 24/08/2026 \\
    \hline
\end{tabularx}
...
\section{Anexos}
\subsection*{Anexo 1: Acta de Validación de Línea Base de Requerimientos y Planificación}
Se certifica la entrega formal de los 7 documentos técnicos de la Semana 1 para revisión por el docente tutor de la cátedra de Gestión de Proyectos de Software.
