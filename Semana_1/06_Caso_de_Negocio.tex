...
\begin{enumerate}[leftmargin=1.5em, itemsep=2pt]
    ...
    \item \textbf{Cero Costos de Licenciamiento Comercial:} Stack tecnológico basado 100\% en software open-source (Node.js + Express v5, React + Vite, PostgreSQL 18, MinIO, Docker, LanguageTool).
\end{enumerate}
...
\begin{tabularx}{\textwidth}{|>{\hsize=0.85\hsize\bfseries}X|>{\hsize=1.2\hsize}X|>{\hsize=0.65\hsize\centering\arraybackslash}X|>{\hsize=0.5\hsize\centering\arraybackslash}X|}
    ...
    \hline
    Base de Datos PostgreSQL & PostgreSQL 18 gestionado con backups diarios & 6 meses (\$18.00/mes) & \$108.00 \\
    \hline
...
\begin{tabularx}{\textwidth}{|>{\hsize=0.75\hsize\bfseries}X|>{\hsize=0.3\hsize\centering\arraybackslash}X|>{\hsize=0.3\hsize\centering\arraybackslash}X|>{\hsize=1.65\hsize}X|}
    ...
    \hline
    R-01: Reglas de Bloqueo Estricto & Media & Alto & Batería de pruebas unitarias exhaustivas en backend (Node.js + Express v5) para evitar falsos positivos en el guardado. \\
    \hline
