...
\begin{itemize}[leftmargin=1.5em, itemsep=1.5pt, topsep=1.5pt]
    ...
    \item \textbf{Período de Ejecución:} Semana 1 (14/08/2026 al 18/08/2026)
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.82\textwidth,height=5.5cm,keepaspectratio]{images/s1_02_matriz_poder_interes.png}
...
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}m{2.9cm}|>{\raggedright\arraybackslash}X|>{\centering\arraybackslash}m{4.6cm}|>{\centering\arraybackslash}m{2.3cm}|}
    ...
    \hline
    \textbf{Elaborado por:} & Steeven Toala\newline \textit{Líder de Proyecto / Arquitecto Software} & \parbox[c]{4.4cm}{\centering\vspace{4pt}\includegraphics[height=1.5cm,width=4.0cm,keepaspectratio]{images/firma_steveen.png}\vspace{4pt}} & 18/08/2026 \\
    \hline
